# TP1 - Inferencia EstadC-stica y Reconocimiento de Patrones
# Parte de regresiC3n en R
...
# El modelo lineal mC:ltiple es estadC-sticamente significativo (p < 2.2e-16),
...
# Las variables con mayor evidencia estadC-stica (p < 0.001) son alcohol, 
# volatile y sulphates.

# Las variables con poca evidencia estadC-stica (p > 0.05) son:
